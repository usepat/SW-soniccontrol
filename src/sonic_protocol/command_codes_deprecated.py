...
@unique
class BaseCommandCodeDeprecated(ICommandCode):
...
@unique
class CommandCodeDeprecated(ICommandCode):
    """!
    ...
    NOTIFY_MESSAGE = BaseCommandCodeDeprecated.NOTIFY_MESSAGE.value
    # NOTIFY_TUNE = 18001
    ...
    INTERNAL_COMMAND = BaseCommandCodeDeprecated.INTERNAL_COMMAND.value
    SONIC_FORCE = 19040
    ...
    # Error codes
    E_INTERNAL_DEVICE_ERROR = BaseCommandCodeDeprecated.E_INTERNAL_DEVICE_ERROR.value
    E_COMMAND_NOT_KNOWN = BaseCommandCodeDeprecated.E_COMMAND_NOT_KNOWN.value
    E_COMMAND_NOT_IMPLEMENTED = BaseCommandCodeDeprecated.E_COMMAND_NOT_IMPLEMENTED.value
    E_COMMAND_NOT_PERMITTED = BaseCommandCodeDeprecated.E_COMMAND_NOT_PERMITTED.value
    E_COMMAND_INVALID = BaseCommandCodeDeprecated.E_COMMAND_INVALID.value
    E_SYNTAX_ERROR = BaseCommandCodeDeprecated.E_SYNTAX_ERROR.value
    E_INVALID_VALUE = BaseCommandCodeDeprecated.E_INVALID_VALUE.value
    E_PARSING_ERROR = BaseCommandCodeDeprecated.E_PARSING_ERROR.value
    E_TIMEOUT_ERROR = BaseCommandCodeDeprecated.E_TIMEOUT_ERROR.value
