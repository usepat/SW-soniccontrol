...
@server_bp.get("/pico_devices")
@execute_in_event_loop
async def get_pico_devices():
    include_ttys = request.args.get("include_ttys", True, type=bool)
    include_disks = request.args.get("include_disks", True, type=bool)
