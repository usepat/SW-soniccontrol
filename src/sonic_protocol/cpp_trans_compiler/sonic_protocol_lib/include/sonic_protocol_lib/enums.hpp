...
std::string_view convert_communication_channel_to_string(CommunicationChannel value) {
...
std::string_view convert_communication_protocol_to_string(CommunicationProtocol value) {
...
std::string_view convert_device_type_to_string(DeviceType value) {
...
std::string_view convert_input_source_to_string(InputSource value) {
